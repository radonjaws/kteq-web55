...
function enablePhases() {
  // Seed first tab from current single-phase fields
...
function disablePhases() {
  // Promote first phase content back to root fields
...
function buildPayload() {
  ...
  if (usePhases.value && form.phases.length > 0) {
    ...
    // Dated mode: sort by phaseEnd, set reorder warning
  ...
  <div class="min-h-dvh bg-kteq-black">
    ...
    <div class="mx-auto max-w-4xl px-4 py-8">
      ...
      <div class="flex items-start justify-between">
        <div>
          ...
          <p v-else class="mt-1 text-sm text-kteq-muted">
            Set it as active from the <RouterLink to="/admin/campaigns" class="text-kteq-yellow/70 hover:text-kteq-yellow transition-colors">campaigns list</RouterLink>.
          </p>
        </div>
        <div class="flex items-center gap-3">
      ...
      <form v-else @submit.prevent="handleSave" class="mt-8 space-y-6">
          ...
          <div class="space-y-4">
            ...
            <template v-if="usePhases && form.phases.length > 0">
              ...
              <div class="-mx-6 border-y border-kteq-gray/20 bg-kteq-void/50">
                <div class="flex items-center px-6 overflow-x-auto">
                  <button
                    ...
                    :class="activePhaseTab === i
                      ? 'text-kteq-yellow border-b-2 border-kteq-yellow -mb-px'
                  ...
                  >
                    ...
                    <span
                      ...
                      class="ml-0.5 flex h-4 w-4 items-center justify-center rounded-full text-kteq-muted/60 hover:bg-kteq-gray/50 hover:text-kteq-light transition-colors cursor-pointer"
                      title="Remove phase"
                    >×</span>
                  </button>
                  <!-- Add phase -->
              ...
              <div v-if="form.phases[activePhaseTab]" class="space-y-4 pt-1">
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input type="text" v-model="form.phases[activePhaseTab].headline" placeholder="Override headline"
                  ...
                  <div>
                    ...
                    <input type="text" v-model="form.phases[activePhaseTab].subhead" placeholder="Override subhead"
                      class="w-full rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-body text-sm text-kteq-white placeholder-kteq-muted/40 focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors" />
                  </div>
                </div>
                ...
                <div class="grid gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <input type="text" v-model="form.phases[activePhaseTab].ctaPrimary" placeholder="Override primary button text"
                      class="w-full rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-body text-sm text-kteq-white placeholder-kteq-muted/40 focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors" />
                  </div>
                  <div>
                    ...
                    <input type="text" v-model="form.phases[activePhaseTab].ctaSecondary" placeholder="Override secondary button text"
                      class="w-full rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-body text-sm text-kteq-white placeholder-kteq-muted/40 focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors" />
                  </div>
                </div>
                ...
                <div v-if="form.scheduleType === 'dated'">
                  ...
                  <div class="grid gap-2 sm:grid-cols-2">
                    <input type="date" v-model="form.phases[activePhaseTab].phaseEndDate"
                      class="rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-mono text-sm text-kteq-white focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors" />
            ...
            <template v-else>
              <div class="grid gap-4 sm:grid-cols-2">
                <div>
                  <label class="mb-1.5 block font-display text-sm font-medium text-kteq-light">Headline <span class="font-normal text-kteq-muted">(optional)</span></label>
                  <input type="text" v-model="form.headline" placeholder="Override headline"
                    class="w-full rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-body text-sm text-kteq-white placeholder-kteq-muted/40 focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors" />
                </div>
                <div>
                  <label class="mb-1.5 block font-display text-sm font-medium text-kteq-light">Subhead <span class="font-normal text-kteq-muted">(optional)</span></label>
                  <input type="text" v-model="form.subhead" placeholder="Override subhead"
                    class="w-full rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-body text-sm text-kteq-white placeholder-kteq-muted/40 focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors" />
                </div>
              </div>
              <div class="grid gap-4 sm:grid-cols-2">
                <div>
                  <label class="mb-1.5 block font-display text-sm font-medium text-kteq-light">Primary CTA Text <span class="font-normal text-kteq-muted">(optional)</span></label>
                  <input type="text" v-model="form.ctaPrimary" placeholder="Override primary button text"
                    class="w-full rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-body text-sm text-kteq-white placeholder-kteq-muted/40 focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors" />
                </div>
                <div>
                  <label class="mb-1.5 block font-display text-sm font-medium text-kteq-light">Secondary CTA Text <span class="font-normal text-kteq-muted">(optional)</span></label>
                  <input type="text" v-model="form.ctaSecondary" placeholder="Override secondary button text"
                    class="w-full rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-body text-sm text-kteq-white placeholder-kteq-muted/40 focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors" />
                </div>
              </div>
              <p class="text-xs text-kteq-muted">All text fields are optional — leave any empty to use the defaults. Button routing and action type are not yet configurable here.</p>
            </template>
        ...
        <!-- ── Phase Schedule ─────────────────────────────────────────────── -->
        <section class="rounded-lg border border-kteq-gray/30 bg-kteq-dark p-6">
          <h2 class="mb-5 font-display text-base font-semibold text-kteq-white">Phase Schedule</h2>
          <div class="space-y-5">
            ...
            <p class="text-xs text-kteq-muted">Campaign dates are context only — they're displayed on the campaigns list but don't activate or deactivate the campaign automatically.</p>
            ...
            <!-- Schedule type + rotator (phases enabled only) -->
            <template v-if="usePhases">
              <!-- Advancement mode -->
              <div>
                ...
                <div class="flex items-end gap-3">
                  <div>
                    ...
                    <input
                      ...
                      min="1"
                      class="w-24 rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-mono text-sm text-kteq-white focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors"
                    />
                  </div>
                  <div>
                    ...
                    <select
                      ...
                      class="rounded-md border border-kteq-gray/50 bg-kteq-void px-3 py-2 font-body text-sm text-kteq-white focus:border-kteq-yellow/50 focus:outline-none focus:ring-1 focus:ring-kteq-yellow/50 transition-colors"
                    >
